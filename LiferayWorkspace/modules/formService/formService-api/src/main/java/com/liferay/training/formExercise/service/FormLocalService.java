...
/**
 * Provides the local service interface for Form. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FormLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FormLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.formExercise.service.impl.FormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FormLocalServiceUtil} if injection and service tracking are not available.
	 */
